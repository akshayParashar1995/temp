 ...
 */
public class PutawayProductItemDetailsListAdapter extends BaseAdapter {
    ...
    public PutawayProductItemDetailsListAdapter(Activity activity, List<Product> list, Resources resLocal){
