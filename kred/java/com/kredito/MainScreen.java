...
public class MainScreen extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = (ListView) findViewById(R.id.list);String[] array={"one","two","three","four","five","six","six","six","six","six","six","six","six","six","six","six","six","six","six","six"};
...
// No image found => let's generate it!
                    ...
                    Bitmap newImg = Blur.fastblur(MainScreen.this, image, 12);
